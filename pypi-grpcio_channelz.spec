...
Version  : 1.71.0
Release  : 78
URL      : https://files.pythonhosted.org/packages/5a/0d/fa7af5efddba5b30c92cae300abb52d3e5d88ff69436961f4b963bf833ef/grpcio_channelz-1.71.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/5a/0d/fa7af5efddba5b30c92cae300abb52d3e5d88ff69436961f4b963bf833ef/grpcio_channelz-1.71.0.tar.gz
...
%prep
%setup -q -n grpcio_channelz-1.71.0
cd %{_builddir}/grpcio_channelz-1.71.0
pushd ..
cp -a grpcio_channelz-1.71.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741776312
