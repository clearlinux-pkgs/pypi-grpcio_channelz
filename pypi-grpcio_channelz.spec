...
Version  : 1.64.1
Release  : 61
URL      : https://files.pythonhosted.org/packages/21/1f/015522403116c912271deabc06d5eb357d3101fafc0d1e1dd31c2a17e08c/grpcio_channelz-1.64.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/21/1f/015522403116c912271deabc06d5eb357d3101fafc0d1e1dd31c2a17e08c/grpcio_channelz-1.64.1.tar.gz
...
%prep
%setup -q -n grpcio_channelz-1.64.1
cd %{_builddir}/grpcio_channelz-1.64.1
pushd ..
cp -a grpcio_channelz-1.64.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717510877
