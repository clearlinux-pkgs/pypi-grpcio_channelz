...
Version  : 1.65.1
Release  : 63
URL      : https://files.pythonhosted.org/packages/55/aa/6ac4cd2d5d175a2115f62ccd503b524d39031a924cdc15b51f849822aaea/grpcio_channelz-1.65.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/55/aa/6ac4cd2d5d175a2115f62ccd503b524d39031a924cdc15b51f849822aaea/grpcio_channelz-1.65.1.tar.gz
...
%prep
%setup -q -n grpcio_channelz-1.65.1
cd %{_builddir}/grpcio_channelz-1.65.1
pushd ..
cp -a grpcio_channelz-1.65.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721316957
