...
Version  : 1.46.3
Release  : 23
URL      : https://files.pythonhosted.org/packages/b1/d5/eb77ed94f9998aecc012a9f9f984593231f4deefeb866e0e366fa3d052dd/grpcio-channelz-1.46.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/b1/d5/eb77ed94f9998aecc012a9f9f984593231f4deefeb866e0e366fa3d052dd/grpcio-channelz-1.46.3.tar.gz
...
%prep
%setup -q -n grpcio-channelz-1.46.3
cd %{_builddir}/grpcio-channelz-1.46.3
pushd ..
cp -a grpcio-channelz-1.46.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653335091
...
cp %{_builddir}/grpcio-channelz-1.46.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_channelz/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
