...
Source0  : https://files.pythonhosted.org/packages/37/9a/da6cee3c30425bfdcf95ba07a4dbfe6b5f947decbe99e197133b952fa603/grpcio-channelz-1.44.0.tar.gz
...
%prep
%setup -q -n grpcio-channelz-1.44.0
cd %{_builddir}/grpcio-channelz-1.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649755700
...
cp %{_builddir}/grpcio-channelz-1.44.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_channelz/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
