...
Version  : 1.46.1
Release  : 22
URL      : https://files.pythonhosted.org/packages/df/d5/e6df189b2a880e09e30fb5e46fe48ee8d6a22892780080d91ab267a3525b/grpcio-channelz-1.46.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/df/d5/e6df189b2a880e09e30fb5e46fe48ee8d6a22892780080d91ab267a3525b/grpcio-channelz-1.46.1.tar.gz
...
%prep
%setup -q -n grpcio-channelz-1.46.1
cd %{_builddir}/grpcio-channelz-1.46.1
pushd ..
cp -a grpcio-channelz-1.46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653334246
...
cp %{_builddir}/grpcio-channelz-1.46.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio_channelz/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
