...
Version  : 1.65.2
Release  : 64
URL      : https://files.pythonhosted.org/packages/9f/6a/923d5be442a964c1cb0a47ac83e7a99ae1901bd1b2d5e79b20618ca5c084/grpcio_channelz-1.65.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/9f/6a/923d5be442a964c1cb0a47ac83e7a99ae1901bd1b2d5e79b20618ca5c084/grpcio_channelz-1.65.2.tar.gz
...
%prep
%setup -q -n grpcio_channelz-1.65.2
cd %{_builddir}/grpcio_channelz-1.65.2
pushd ..
cp -a grpcio_channelz-1.65.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722441418
