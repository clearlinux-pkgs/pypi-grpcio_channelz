...
Version  : 1.69.0
Release  : 75
URL      : https://files.pythonhosted.org/packages/6d/f9/92b3bd409b92dbe3b3aef9a8da0a96a01132b33a61a3e3bc886ea49d8f84/grpcio_channelz-1.69.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/6d/f9/92b3bd409b92dbe3b3aef9a8da0a96a01132b33a61a3e3bc886ea49d8f84/grpcio_channelz-1.69.0.tar.gz
...
%prep
%setup -q -n grpcio_channelz-1.69.0
cd %{_builddir}/grpcio_channelz-1.69.0
pushd ..
cp -a grpcio_channelz-1.69.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736178988
